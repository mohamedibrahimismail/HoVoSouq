...
public class OffersActivityAdapter extends RecyclerView.Adapter<OffersActivityAdapter.ViewHolder> {

    private List<String> contents;
    private Context mContext;
    public OffersActivityAdapter(List<String> contents, Context mContext) {
